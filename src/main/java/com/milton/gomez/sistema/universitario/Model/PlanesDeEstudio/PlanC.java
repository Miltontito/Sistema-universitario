...
public class PlanC implements ModelPlanDeEstudio {
    @Override
    ...
    private boolean aproboLosFinalesDeLosCuatrimestres(ModelAlumno alumno, List<ModelCuatrimestre> cuatrimestres) {
        ...
        List<ModelCuatrimestre> primerosCincoCuatrimestres = cuatrimestres.subList(cuatrimestres.size() - 5, cuatrimestres.size());
